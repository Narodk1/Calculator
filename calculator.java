...
int calculation;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String store;
        if(lenght>0){
            StringBuilder back=new StringBuilder(jTextField1.getText());//bach nkhazan les strings
            back.deleteCharAt(number);//methode to delete single char from specific position//number: variable de pos bcoz i want delete length by one
            store=back.toString();//convert stringbuilder in string bcoz textfielf take ony strin 
